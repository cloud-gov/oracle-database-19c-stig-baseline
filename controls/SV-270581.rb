control 'SV-270581' do
  title 'The database management system (DBMS) and associated applications must reserve the use of dynamic code execution for situations that require it.'
...
If dynamic code execution is employed in circumstances where the objective could practically be satisfied by static execution with strongly typed parameters, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-74614r1065019_chk'
  tag severity: 'medium'
  tag gid: 'V-270581'
  tag rid: 'SV-270581r1065225_rule'
  tag stig_id: 'O19C-00-018000'
  tag gtitle: 'SRG-APP-000251-DB-000391'
  tag fix_id: 'F-74515r1065020_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
