control 'SV-270517' do
  title 'Database software directories, including database management system (DBMS) configuration files, must be stored in dedicated directories, or DASD pools, separate from the host OS and other applications.'
  ...
  desc 'check', 'Review the DBMS software library directory and note other root
  ...
  desc 'fix', 'Install all applications on directories, or pools, separate from the DBMS software library directory. Relocate any directories or reinstall other application software that currently shares the DBMS software library directory to separate directories.
...
For mainframe-based databases, locate database software and configuration files in separate DASD pools from other mainframe applications.'
  ...
  tag gid: 'V-270517'
  tag rid: 'SV-270517r1064829_rule'
  tag stig_id: 'O19C-00-008100'
  tag fix_id: 'F-74451r1064828_fix'
  tag cci: ['CCI-001499']
