control 'SV-270582' do
  title 'The database management system (DBMS) and associated applications, when making use of dynamic code execution, must take steps against invalid values that may be used in a SQL injection attack, therefore resulting in steps to prevent a SQL injection attack.'
...
If dynamic code execution is employed without protective measures against code injection, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-74615r1065022_chk'
  tag severity: 'medium'
  tag gid: 'V-270582'
  tag rid: 'SV-270582r1065226_rule'
  tag stig_id: 'O19C-00-018100'
  tag gtitle: 'SRG-APP-000251-DB-000392'
  tag fix_id: 'F-74516r1065023_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
  ...
  describe "SV-270582: manual review required (no automated test defined)" do
    skip "SV-270582 requires manual review; no automated assertion is defined."
  end
end
