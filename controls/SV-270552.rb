...
Demonstration and sample database objects and applications present publicly known attack points for malicious users. These demonstration and sample objects are meant to provide simple examples of coding specific functions and are not developed to prevent vulnerabilities from being introduced to the database management system (DBMS) and host system.'
  desc 'check', "If Oracle is hosted on a server that does not support production systems, and is designated for the deployment of samples and demonstrations, this is Not Applicable.
...
If any of the users listed above is returned, it means that there are demo programs installed, and this is a finding."
  ...
  tag gid: 'V-270552'
  tag rid: 'SV-270552r1064934_rule'
  tag stig_id: 'O19C-00-012900'
  tag fix_id: 'F-74486r1064933_fix'
  tag cci: ['CCI-000381']
