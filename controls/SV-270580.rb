...
DISABLE, VALIDATE
DISABLE, NOVALIDATE"
  desc 'check', 'Review database management system (DBMS) code, settings, field definitions, constraints, and triggers to determine whether or not data being input into the database is validated.
...
An ALTER TABLE statement that defines and attempts to enable an integrity constraint can fail because rows of the table violate the integrity constraint. If this case, the statement is rolled back, and the constraint definition is not stored and not enabled.)
  ...
  tag gid: 'V-270580'
  tag rid: 'SV-270580r1068300_rule'
  tag stig_id: 'O19C-00-017900'
  tag fix_id: 'F-74514r1068299_fix'
  tag cci: ['CCI-001310']
