control 'SV-270537' do
  ...
  desc 'The database management system (DBMS) installation account may be used by any authorized user to perform DBMS installation or maintenance. Without logging, accountability for actions attributed to the account is lost.'
  desc 'check', 'Review documented and implemented procedures for monitoring the use of the DBMS software installation account in the system documentation.
...
Ensure all accounts with administrator privileges are monitored for DBMS host on Windows OS platforms.'
  ...
  tag gid: 'V-270537'
  tag rid: 'SV-270537r1064889_rule'
  tag stig_id: 'O19C-00-010700'
  tag fix_id: 'F-74471r1064888_fix'
  tag cci: ['CCI-000366']
