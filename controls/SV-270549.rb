...
Check the settings for password_lock_time - this specifies how long to lock the account after the number of consecutive failed logon attempts reaches the limit. If the value is not UNLIMITED, this is a finding."
  desc 'fix', 'Configure the database management system (DBMS) settings to specify indefinite lockout duration:

ALTER PROFILE ORA_STIG_PROFILE LIMIT PASSWORD_LOCK_TIME UNLIMITED;'
  impact 0.5
  tag gtitle: 'SRG-APP-000516-DB-000363'
  tag gid: 'V-270549'
  tag rid: 'SV-270549r1112480_rule'
  tag stig_id: 'O19C-00-012300'
  tag fix_id: 'F-74483r1064924_fix'
  tag cci: ['CCI-002236', 'CCI-000366']
  tag nist: ['AC-7 b', 'Rev_4', 'CM-6 b']
  tag 'false_negatives'
  tag 'false_positives'
  tag 'documentable'
  tag 'mitigations'
