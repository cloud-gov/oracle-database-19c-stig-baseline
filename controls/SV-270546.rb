control 'SV-270546' do
  title 'Oracle Database must provide a mechanism to automatically identify accounts designated as temporary or emergency accounts.'
...
PASSWORD_VERIFY_FUNCTION – This clause allows a PL/SQL password complexity verification script to be passed as an argument to the CREATE PROFILE statement. Oracle Database provides a default script, but users can create their own routine or use third-party software instead.'
  ...
  tag gid: 'V-270546'
  tag rid: 'SV-270546r1112478_rule'
  tag stig_id: 'O19C-00-012000'
  tag fix_id: 'F-74480r1112477_fix'
  tag cci: ['CCI-000016', 'CCI-000366']
  tag nist: ['AC-2 (2)', 'Rev_4', 'CM-6 b']
  tag 'false_negatives'
  tag 'false_positives'
  tag 'documentable'
  tag 'mitigations'
